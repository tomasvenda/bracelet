...
#define TRAIN_PAST_SAMPLES    75
#define TRAIN_FUTURE_SAMPLES  150
#define TRAIN_TOTAL_SAMPLES   225   /* 1.5 s past + 3.0 s future @ 50 Hz */
...
/* Extended capture. count must be TRAIN_TOTAL_SAMPLES * 4.
 * Layout per frame: x_g, y_g, z_g, ABSOLUTE pressure in hPa. */
